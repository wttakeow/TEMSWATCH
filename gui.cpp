...
MenuBar::lv_menu_config_t _cfg[6] = {
    {.name = "ไวไฟ",  .img = (void *) &wifi, .event_cb = wifi_event_cb},
    {.name = "บูลธูท",  .img = (void *) &bluetooth, /*.event_cb = bluetooth_event_cb*/},
    {.name = "การ์ดSD",  .img = (void *) &sd,/*.event_cb =sd_event_cb*/},
    {.name = "ทดสอบยิง",  .img = (void *) &warning,  .event_cb = alert_event_cb },
    {.name = "ตั้งค่า",  .img = (void *) &setting, /*.event_cb = setting_event_cb */},
    {.name = "ทดสอบภาษาไทย",  .img = (void *) &CAMERA_PNG,/*.event_cb = camera_event_cb*/ }
};
...
void setupGui()
{
    ...
    //Create wallpaper
    void *images[] = {(void *) &linus240, (void *) &linus240, (void *) &linus240, (void *) &linus240 };
...
const char *Keyboard::btnm_mapplus[10][23] = {
    {
        ...
        "d", "e", "f",   "\n",
        "g", "h", "i",   "\n",
        LV_SYMBOL_OK, "Del", "Exit", LV_SYMBOL_LEFT, LV_SYMBOL_RIGHT , ""
    },
    {
        "j", "k", "l", "\n",
        "n", "m", "o",  "\n",
